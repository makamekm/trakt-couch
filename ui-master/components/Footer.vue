<template>
  <div class="flex justify-center items-center pt-8 space-x-2 my-2">
    <div class="lg:hidden text-gray-500 text-xs">
      2021 &#169;
    </div>
    <span class="w-1 mx-4 h-1 bg-gray-300 rounded-full lg:hidden" />

    <div class="text-gray-500 text-xs hidden lg:inline">
      &#169; Developed by Maxim Karpov in 2021
    </div>
    <span class="w-1 mx-4 h-1 bg-gray-300 rounded-full hidden lg:inline" />

    <a rel="noreferrer" href="https://github.com/makamekm" target="_blank"><svg
    ...
    <span class="w-1 mx-4 h-1 bg-gray-300 rounded-full" />
    <a rel="noreferrer" href="https://twitter.com/makamekm" target="_blank"><svg
      class="w-6 h-6 text-gray-600 hover:text-gray-800"
      xmlns="http://www.w3.org/2000/svg"
      xmlns:xlink="http://www.w3.org/1999/xlink"
      aria-hidden="true"
